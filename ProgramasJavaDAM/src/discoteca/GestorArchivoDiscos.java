...
public class GestorArchivoDiscos {
    ...
    public static void cargarColeccionDesdeAlmacenamiento() {
        ...
        // verificamos si el archivo existe antes de intentar
        // leerlo -->
        if (!fichero.exists()) {
            System.out.println(
                    "No hay archivo de guardado previo. Creando colección nueva...");
        ...
        try (ObjectInputStream ois = new ObjectInputStream(
            ...
            // si resulta que algo falla,al menos
    ...
    public static void guardarColeccionDesdeAlmacenamiento() {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(
                new FileOutputStream("coleccion.obj"))) {
            // Guardamos el array completo de un solo golpe -->
            oos.writeObject(GestorDiscos.discos);
            System.out.println(
                    "Coleccion guardada correctamente en coleccion.obj");
