...
public class Notas {
    ...
    double calcularPromedio() {
        ...
        /*
         * Obtiene el promedio como la división de la suma de notas sobre el total de
         * notas
         */
    ...
    double calcularDesviacion() {
        ...
        for (int i = 0; i < listaNotas.length; i++) {
            ...
            suma += Math.pow(listaNotas[i] - prom, 2); // (x-med)^2
        }
    ...
    /**
     * Método que calcula el valor menor del array de notas * @return El valor menor
     * del array de notas
     */
